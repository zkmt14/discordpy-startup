...
features = ["大きい","小さい","漆黒の","美しい","なんかべとついてる","大量の","おいしそうな","のりしおの匂いがする","しめった","放置されてる","カビくさい","青白く光り輝く","妖艶な","超絶怒涛の","アメリカ在住の","とげとげしてる"]
somethings = ["回すメン"."テレビのリモコン","小石","お隣さん","ダイヤモンド","月","とんぼの羽","床の埃","ENTERキー","ピンポン球","カレーライス","ぜっと","カマドウマ","吉野家の牛丼","三ツ矢サイダー","耳栓（片方だけ）"]
